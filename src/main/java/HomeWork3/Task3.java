...
public class Task3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//h1[contains(@class, 'banner__title')]/parent::div[contains(@class, 'banner__wrapper')]/child::div[contains(@class, 'banner__btns')]/a[contains(@class, 'main-banner-btn') and contains(@class, 'btn-gradient')]")).click();
        Thread.sleep(4000);
        driver.quit();
    }
}
